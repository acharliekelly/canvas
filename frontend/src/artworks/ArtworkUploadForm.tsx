  ...
  return (
    <section aria-labelledby="upload-heading">
      ...
      <form onSubmit={submit} noValidate>
        <div className="field"><label htmlFor="artwork-image">Artwork image</label><input id="artwork-image" name="image" type="file" accept="image/png,image/jpeg" required aria-invalid={Boolean(fieldError("image"))} aria-describedby={fieldError("image") ? "artwork-image-error" : undefined} />{fieldError("image") && <p className="field-error" id="artwork-image-error">{error?.message}</p>}</div>
        <div className="field"><label htmlFor="artwork-title">Title</label><input id="artwork-title" name="title" required aria-invalid={Boolean(fieldError("title"))} aria-describedby={fieldError("title") ? "artwork-title-error" : undefined} />{fieldError("title") && <p className="field-error" id="artwork-title-error">{error?.message}</p>}</div>
        <div className="field"><label htmlFor="artwork-credit">Artist or display credit</label><input id="artwork-credit" name="credit" required aria-invalid={Boolean(fieldError("credit"))} aria-describedby={fieldError("credit") ? "artwork-credit-error" : undefined} />{fieldError("credit") && <p className="field-error" id="artwork-credit-error">{error?.message}</p>}</div>
